...
class Sfn {
    ...
    static public function criptPass($pass) { //убрать
        return md5(md5($pass) . 'bou5s@l#mea2d');
    }
...
#region находки
    ...
    /*
      отфильтровываем в записях только нужное получаем массив отфильтрованых
